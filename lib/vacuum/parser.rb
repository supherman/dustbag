...
require 'vacuum/parsers/simple_product'
...
require 'vacuum/parsers/dimension'
require 'vacuum/parsers/dimensions'
require 'vacuum/parsers/availability_attributes'
require 'vacuum/parsers/accessory'
require 'vacuum/parsers/accessories'
require 'vacuum/parsers/offer'
require 'vacuum/parsers/offers'
require 'vacuum/parsers/customer_reviews'
require 'vacuum/parsers/editorial_review'
require 'vacuum/parsers/editorial_reviews'
require 'vacuum/parsers/similar_product'
require 'vacuum/parsers/similar_products'
require 'vacuum/parsers/browse_nodes'
require 'vacuum/parsers/browse_node'
require 'vacuum/parsers/language'
require 'vacuum/parsers/languages'
require 'vacuum/parsers/item_attributes'
require 'vacuum/parsers/item_link'
require 'vacuum/parsers/item_links'
require 'vacuum/parsers/variation_summary'
require 'vacuum/parsers/variations'
require 'vacuum/parsers/variation_attribute'
require 'vacuum/parsers/variation_attributes'
